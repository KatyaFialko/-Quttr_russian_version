...
DropDown.prototype = {
    initEvents: function () {
        ...
        obj.opts.on('click', function (ev) {
            ...
            obj.index = opt.index();
            if (obj.valueElement) {
                const val = opt.context.getElementsByClassName("phoneMenuItem")[0].getElementsByClassName("number1")[0].innerText;
...
$(function () {
    ...
    array.forEach(el => {
        ...
        const num = $("<div class='number1'>")
        const country = $("<div class='country'>")
        country.text(el[0]);
        num.text(el[1])
        div.append(num);
        div.append(country);
